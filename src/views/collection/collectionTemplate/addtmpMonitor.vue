      ...
      <div class="deleteCon systemUser">
        <div class="deleteListCon">
          ...
          <div class="sy-publish-dialog-content">
            ...
            >
              ...
              <dd class="rm-advanced-search-dd" style="padding-left: 14px;width: auto;">
                <div class="flt" style="position: relative">
                  ...
                  ></i>
                  <em
                    style="color: red;position: absolute;top: 10px;left: 322px;"
                    >*</em
                  >
                  <div
                    class="downMenuShow"
                  ...
                  <div class="error-tips-box" style="left:2px;">
                    {{ taskNameTip }}
                  </div>
                </div>
              </dd>
            ...
            >
              ...
              <dd class="rm-advanced-search-dd" style="padding-left: 14px;width: auto;">
                ...
                ><span
                  ...
                  >*</span
                >
                <div class="error-tips-box" style="top: 72px;">
                  {{ regexTip }}
                </div>
              </dd>
            </dl>
            ...
            <dl class="rm-advanced-search-dl clearfix publicList">
              ...
              <dd
                class="rm-advanced-search-dd flt"
                style="padding-left: 14px;position: relative;width: auto;"
              >
        ...
        <footer class="dialog-footer">
          <ul class="btn-list btn-list-ymj" style="float: left;">
            <li class="btn-item btn-item-acvite-ymj" @click="sureBtn()">
              保存
            </li>
...
import { searchTaskKey, addTmpApi } from "@/api/getDate";
export default {
  data() {
    return {
      testUrl: "",
  ...
  mounted() {
    ...
    if (this.$route.query.TmpTaskId) {
      //从任务列表跳转到模板配置页面
      this.TmpTaskShow = false;
      this.taskName = this.$route.query.TmpTaskName;
      this.taskId = this.$route.query.TmpTaskId;
    } else {
      this.TmpTaskShow = true;
      this.taskName = "";
      this.taskId = "";
    }
    this.getAllTaskName();
      ...
      addTmpApi(
        ...
        .then(res => {
          ...
          if (res.code == "1" || res.code == 1) {
            // if(this.$route.query.TmpTaskId){ //从任务列表跳转到模板配置页面
            //   this.$router.push({
            //     path: 'collectionTask',
            //     name: 'collectionTask',
            //   })
