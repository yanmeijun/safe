        ...
        <el-card class="box-card">
          ...
          <div>
            <div style="text-align: center">
              <div class="el-upload">
                <img
                  :src="
                    user.avatarName
                      ? baseApi + user.avatarPath.substring(1)
                      : user.deptInfo.sysLogo
                  "
                  title="点击上传头像"
                  class="avatar"
                  @click="toggleShow"
            ...
            <ul class="user-info">
              ...
              <li>
                <svg-icon icon-class="dept" /> 所属机构
                <div class="user-right">{{ user.dept.name }}</div>
              </li>
              <li>
                <svg-icon icon-class="dept" /> 登录角色
                <div class="user-right">{{ user.roles[0].name }}</div>
              </li>
              <li>
