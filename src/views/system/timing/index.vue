<template>
  <div class="app-container">
    <!--工具栏-->
    <div class="sysMonitorBox">
      <div class="head-container">
        <div v-if="crud.props.searchToggle" class="clearfix">
          <!-- 搜索 -->
          <el-input
        ...
        >
          ...
          <el-form-item label="任务状态">
            <el-radio-group v-model="form.isPause" style="width: 220px">
              <el-radio label="0" key="0">启用</el-radio>
              <el-radio label="1" key="1">暂停</el-radio>
            </el-radio-group>
          </el-form-item>
      ...
      >
        ...
        >
          <template slot-scope="scope">
            <el-tag :type="scope.row.isPause == '1' ? 'warning' : 'success'">{{
              scope.row.isPause == "1" ? "已暂停" : "运行中"
            }}</el-tag>
          </template>
        </el-table-column>
        <el-table-column
